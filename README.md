...
> **Visual deployment diagram:** embedded on the [live site](https://serval-orchestrator.burademirung.workers.dev) under **Deployment** (the "Deployed on Cloudflare" tile) — a one-glance view of the Worker, the five Durable Objects, and Claude via AI Gateway.
